...
Window::Window(QWidget *parent) : QMainWindow(parent), ui(new Ui::Window) {
  ...
  QImageButtonSettings search_settings(search_IB_path, search_IB_name,
                                       search_IB_bg_color);
  ...
  QImageButtonSettings sell_settings(sell_IB_path, sell_IB_name,
                                     sell_IB_bg_color);
  ...
  QImageButtonSettings list_settings(list_IB_path, list_IB_name,
                                     list_IB_bg_color);
